...
- L'hash della prova
- Facoltativamente la voce del registro (VIP-STD-002)
...
4. Rifiutare le firme non corrispondenti
...
La validazione parziale della firma NON DEVE dichiarare conformità.
...
- Validazione della firma interoperabile
