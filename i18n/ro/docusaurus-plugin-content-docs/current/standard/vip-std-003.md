...
- Structura obiectului de semnătură
...
- Hash-ul dovezii
- Opțional, intrarea în registru (VIP-STD-002)
...
Reprezentarea exactă a octeților definită în VIP-STD-001 Anexa C TREBUIE utilizată.

Nu este permisă reserializarea în timpul verificării.

---

## 4. Structura Obiectului de Semnătură
...
signature_value
TREBUIE să reprezinte octeții brute ai semnăturii codificați în hexazecimal.

---

## 6. Verificare Deterministică

Verificarea TREBUIE să:

1. Recalculeze hash-ul dovezii
2. Reconstruiască reprezentarea canonică a octeților
3. Verifice semnătura față de public_key furnizat
