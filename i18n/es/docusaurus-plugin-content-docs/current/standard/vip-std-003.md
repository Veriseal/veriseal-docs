...
- Reglas de verificación deterministas
...
- Opcionalmente la entrada del libro mayor (VIP-STD-002)
...
Se DEBE utilizar la representación exacta de bytes definida en el Apéndice C de VIP-STD-001.
...
- El algoritmo DEBE ser uno de los algoritmos permitidos
